        ...
        <div className="flex items-center gap-3 mb-5">
          <div className="flex-1 flex flex-col items-center gap-1">
            ...
            <input
              ...
              className="w-full bg-slate-900 border border-slate-700 rounded-xl px-3 py-3 text-2xl font-bold text-yellow-400 text-center focus:outline-none focus:border-yellow-500 focus-visible:ring-2 focus-visible:ring-yellow-500/50"
              placeholder="0"
            />
          </div>
          <span className="text-slate-400 font-bold text-lg pt-5">vs</span>
          <div className="flex-1 flex flex-col items-center gap-1">

-- Scope 8: Restore SQLSTATE errcodes on concurrency exceptions
--
-- Migration 000009 replaced explicit SQLSTATE codes with bare RAISE
-- EXCEPTION text. This forces clients to substring-match English text
-- instead of reliably checking errcode. This migration restores:
--   40001 (serialization_failure) for version mismatch
--   55P03 (lock_not_available) for advisory/row lock conflicts
...
-- Restore errcodes on publish_tournament
